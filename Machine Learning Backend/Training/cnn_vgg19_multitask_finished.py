...
#optimizer = optim.SGD(model.fc_artist.parameters(), lr=0.1,  momentum=0.9, weight_decay=0.0001)
#optimizer = optim.Adam(model.fc_artist.parameters())
#optimizer2 = optim.Adam(model.fc_style.parameters())
#optimizer3 = optim.Adam(model.fc_genre.parameters())


#optimizer = optim.SGD([
#        {"params":model.fc_artist.parameters(),"lr": 0.2,  "momentum":0.9, "weight_decay":0.0001},
#        {"params":model.fc_genre.parameters(),"lr": 0.2,  "momentum":0.9, "weight_decay":0.0001},
#        {"params":model.fc_style.parameters(), "lr": 0.2,"momentum":0.9, "weight_decay":0.0001}])
...
exp_lr_scheduler4 = lr_scheduler.StepLR(optimizer3, step_size=20, gamma=0.1)

#model.load_state_dict(torch.load("cnn_transfer_learning/modelsavepoints/vgg19_pretrained_cnn_model_25epoch_no_lrs.pth"))
#model.load_state_dict(torch.load("cnn_transfer_learning/modelsavepoints/vgg19_pretrained_cnn_model_45epoch_no_lrs.pth"))
model.load_state_dict(torch.load("cnn_transfer_learning/modelsavepoints/vgg19_notrained_cnn_model_45epoch_best_Acc.pth"))
...
def train_model(model, criterion, optimizer, optimizer2, optimizer3,optimizer4, exp_lr_scheduler, exp_lr_scheduler2, exp_lr_scheduler3,exp_lr_scheduler4,num_epochs=3 ):
    ...
    save_path = Path("cnn_transfer_learning/modelsavepoints/vgg19_notrained_cnn_model_45epoch_best_Acc.pth")
...
plt.savefig('output_acc.png', bbox_inches='tight', bbox_extra_artists=(lgd,))
...
plt.savefig('output_loss.png', bbox_inches='tight', bbox_extra_artists=(lgd,))
...
plt.title('Train vs Test Accuracy')
plt.savefig('output_acc_all.png', bbox_inches='tight', bbox_extra_artists=(lgd,))
...
plt.legend(['Train_artist','Train_style', 'Train_genre', 'Test_artist', 'Test_style', 'Test_genre'],  bbox_to_anchor=(1.05, 1), loc='upper left')
plt.title('Train vs Test Losses')
plt.savefig('output_loss_all.png', bbox_inches='tight', bbox_extra_artists=(lgd,))
